        ...
        case 'object':
            {
                ...
                else if ((obj === null || obj === void 0 ? void 0 : obj.type) === 'date') {
                    lines.push(`new Date(${typeof obj.input === 'string' ? JSON.stringify(obj.input) : obj.input})`);
                }
                else {
                    lines.push('{');
...
//# sourceMappingURL=objectUtils-a96545e9.js.map